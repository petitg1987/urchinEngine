...
namespace urchin {
    ...
    class TerrainObstacleService {
        public:
            ...
            TerrainObstacleService(std::string, const Point3<float>&, std::vector<Point3<float>>, unsigned int, unsigned int);

            std::vector<CSGPolygon<float>> computeSelfObstacles(float) const;
