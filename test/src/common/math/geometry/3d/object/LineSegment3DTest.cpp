...
void LineSegment3DTest::closestPoint() {
    ...
    LineSegment3D lineSegment(Point3(1.0f, 1.0f, 0.0f), Point3(2.0f, 1.0f, 0.0f));

    //point outside segment (right)
    Point3<float> closestPoint1 = lineSegment.closestPoint(Point3(3.0f, 2.0f, 0.0f), barycentrics);
    AssertHelper::assertPoint3FloatEquals(closestPoint1, Point3(2.0f, 1.0f, 0.0f));
    AssertHelper::assertFloatEquals(barycentrics[0], 0.0f);
    AssertHelper::assertFloatEquals(barycentrics[1], 1.0f);

    //point in segment
    Point3<float> closestPoint2 = lineSegment.closestPoint(Point3(1.5f, 2.0f, 0.0f), barycentrics);
    AssertHelper::assertPoint3FloatEquals(closestPoint2, Point3(1.5f, 1.0f, 0.0f));
    ...
    Point3<float> closestPoint3 = lineSegment.closestPoint(Point3(-3.0f, 2.0f, 0.0f), barycentrics);
    AssertHelper::assertPoint3FloatEquals(closestPoint3, Point3(1.0f, 1.0f, 0.0f));
