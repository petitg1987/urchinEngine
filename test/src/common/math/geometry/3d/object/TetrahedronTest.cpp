...
void TetrahedronTest::closestPoint() {
    ...
    AssertHelper::assertPoint3FloatEquals(closestPoint1, Point3<float>(2.0f, 3.0f, 0.5f));
    ...
    AssertHelper::assertPoint3FloatEquals(closestPoint2, Point3<float>(3.0f, 0.0f, 1.0f));
    AssertHelper::assertFloatEquals(barycentrics[0], 0.0f);
    AssertHelper::assertFloatEquals(barycentrics[1], 0.0f);
    ...
    AssertHelper::assertPoint3FloatEquals(closestPoint3, Point3<float>(2.0f, 1.78378379f, 0.29729723f));
    AssertHelper::assertFloatEquals(barycentrics[0], 0.0f);
    ...
    AssertHelper::assertPoint3FloatEquals(closestPoint4, Point3<float>(2.0f, 0.0f, 0.5f));
    ...
    AssertHelper::assertPoint3FloatEquals(closestPoint5, Point3<float>(1.9f, 0.5f, 0.5f));
    ...
    AssertHelper::assertPoint3FloatEquals(closestPoint6, Point3<float>(2.0f, 2.9f, 0.5f));
