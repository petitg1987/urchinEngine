...
void OrthogonalProjectionTest::orthogonalProjectionLine2D() {
    ...
    AssertHelper::instance()->assertPoint2FloatEquals(projectedPoint, Point2<float>(3.0, 1.0));
}
...
void OrthogonalProjectionTest::orthogonalProjectionLine3D() {
    ...
    AssertHelper::instance()->assertPoint3FloatEquals(projectedPoint, Point3<float>(3.0, 1.0, 0.0));
}
...
void OrthogonalProjectionTest::orthogonalProjectionPlane() {
    ...
    AssertHelper::instance()->assertPoint3FloatEquals(projectedPoint1, Point3<float>(1.0, -3.0, 0.0));
    ...
    AssertHelper::instance()->assertPoint3FloatEquals(projectedPoint2, Point3<float>(1.0, 1.0, 0.0));
}
