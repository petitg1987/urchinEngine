...
void ResizePolygon2DServiceTest::reduceTriangle() {
    ...
    AssertHelper::instance()->assertPoint2IntEquals(trianglesPoints[0], Point2<int>(-176, -6060));
    AssertHelper::instance()->assertPoint2IntEquals(trianglesPoints[1], Point2<int>(1095, -6060));
    AssertHelper::instance()->assertPoint2IntEquals(trianglesPoints[2], Point2<int>(1095, -4786));
}
