...
void PolygonsSubtractionTest::polygonsSubtractionSubtrahendInside() {
    std::vector<Point2<float>> minuendPoly = {Point2(0.0f, 4.0f), Point2(4.0f, 4.0f),
                                              Point2(4.0f, 0.0f), Point2(0.0f, 0.0f)};

    std::vector<Point2<float>> subtrahendPoly = {Point2(1.0f, 3.0f), Point2(3.0f, 3.0f),
...
void PolygonsSubtractionTest::polygonsSubtractionSubtrahendInsideContactPoint() {
    ...
    std::vector<Point2<float>> subtrahendPoly = {Point2(1.0f, 3.0f), Point2(4.0f, 3.0f),
                                                 Point2(3.0f, 1.0f), Point2(1.0f, 1.0f)};
...
void PolygonsSubtractionTest::polygonsSubtractionSubtrahendOutside() {
    ...
    std::vector<Point2<float>> subtrahendPoly = {Point2(1.0f, 7.0f), Point2(3.0f, 7.0f),
...
void PolygonsSubtractionTest::polygonsSubtractionMinuendInside() {
    std::vector<Point2<float>> minuendPoly = {Point2(1.0f, 3.0f), Point2(3.0f, 3.0f),
                                              Point2(3.0f, 1.0f), Point2(1.0f, 1.0f)};

    std::vector<Point2<float>> subtrahendPoly = {Point2(0.0f, 4.0f), Point2(4.0f, 4.0f),
                                                 Point2(4.0f, 0.0f), Point2(0.0f, 0.0f)};
...
void PolygonsSubtractionTest::polygonsSubtractionMinuendInsideContactEdge() { //see polygonsSubtractionMinuendInsideContactEdge.ggb
    std::vector<Point2<float>> minuendPoly = {Point2(-5.07582092f, 0.225821018f), Point2(5.97582006f, 0.225821018f),
                                              Point2(-5.07582092f, -10.8258209f)};

    std::vector<Point2<float>> subtrahendPoly = {Point2(5.0446701f, -10.9196606f), Point2(-5.9446702f, -10.9196606f),
...
void PolygonsSubtractionTest::polygonsSubtractionMiddlePoint() {
    std::vector<Point2<float>> minuendPoly = {Point2(1.0f, 2.0f), Point2(5.0f, 2.0f), Point2(6.0f, 1.0f),
                                              Point2(5.0f, 0.0f), Point2(1.0f, 0.0f), Point2(0.0f, 1.0f)};

    std::vector<Point2<float>> subtrahendPoly = {Point2(2.0f, 3.0f), Point2(4.5f, 1.5f), Point2(4.0f, -1.0f),
...
void PolygonsSubtractionTest::polygonsSubtractionSameEdge1() {
    ...
    std::vector<Point2<float>> subtrahendPoly = {Point2(1.0f, 5.0f), Point2(3.0f, 5.0f), Point2(3.0f, 3.0f),
    ...
    AssertHelper::assertPolygonFloatEquals(polygonSubtraction[0].getCwPoints(), {Point2(0.0f, 0.0f), Point2(0.0f, 4.0f), Point2(2.0f, 4.0f),
                                                                                 Point2(2.0f, 3.0f), Point2(3.0f, 3.0f), Point2(3.0f, 4.0f),
...
void PolygonsSubtractionTest::polygonsSubtractionSameEdge2() {
    ...
    AssertHelper::assertPolygonFloatEquals(polygonSubtraction[0].getCwPoints(), {Point2(4.0f, 4.0f), Point2(4.0f, 0.0f), Point2(0.0f, 0.0f),
                                                                                 Point2(0.0f, 4.0f), Point2(2.0f, 4.0f), Point2(2.0f, 3.0f),
                                                                                 Point2(3.0f, 3.0f), Point2(3.0f, 4.0f)});
}

void PolygonsSubtractionTest::polygonsSubtractionSameEdge3() { //see polygonsSubtractionSameEdge3.ggb
    std::vector<Point2<float>> minuendPoly = {Point2(-0.175821006f, -4.67417908f), Point2(1.07581997f, -4.67417908f),
                                              Point2(-0.175821006f, -5.9258213f)};

    std::vector<Point2<float>> subtrahendPoly = {Point2(0.14467001f, -6.01966f), Point2(-1.04466999f, -6.01966f),
...
void PolygonsSubtractionTest::polygonsSubtractionSameEdge4() { //see polygonsSubtractionSameEdge4.ggb
    std::vector<Point2<float>> minuendPoly = {Point2(5.76618004f, -6.51731586f), Point2(-5.76618004f, -6.51731586f),
                                              Point2(-5.76618004f, 1.51731598f), Point2(5.76618004f, 1.51731598f)};

    std::vector<Point2<float>> subtrahendPoly = {Point2(-4.24466991f, -9.21965981f), Point2(6.27905893f, 1.76014054f),
    ...
    AssertHelper::assertPolygonFloatEquals(polygonSubtraction[0].getCwPoints(), {Point2(-5.76618004f, -6.51731586f), Point2(-5.76618004f, 1.51731598f),
                                                                                 Point2(5.76618004f, 1.51731598f), Point2(5.76618004f, 1.22503483f),
                                                                                 Point2(-1.65457416f, -6.51731586f)});
...
void PolygonsSubtractionTest::polygonsSubtractionTwoSameEdge1() {
    std::vector<Point2<float>> minuendPoly = {Point2(0.0f, 4.0f), Point2(1.5f, 4.0f), Point2(2.0f, 3.0f),
                                              Point2(2.5f, 4.0f), Point2(4.0f, 4.0f), Point2(4.0f, 0.0f),
                                              Point2(0.0f, 0.0f)};

    std::vector<Point2<float>> subtrahendPoly = {Point2(1.0f, 5.0f), Point2(3.0f, 5.0f), Point2(3.0f, 4.0f),
                                                 Point2(1.0f, 4.0f)};
...
void PolygonsSubtractionTest::polygonsSubtractionTwoSameEdge2() {
    std::vector<Point2<float>> minuendPoly = {Point2(0.0f, 4.0f), Point2(1.5f, 4.0f), Point2(2.0f, 4.5f),
                                              Point2(2.5f, 4.0f), Point2(4.0f, 4.0f), Point2(4.0f, 0.0f),
                                              Point2(0.0f, 0.0f)};
...
void PolygonsSubtractionTest::polygonsSubtractionTwoSameEdge5() { //see polygonsSubtractionTwoSameEdge5.ggb
    std::vector<Point2<float>> minuendPoly = {Point2(4.76618004f, -5.51731586f), Point2(-4.76618004f, -5.51731586f),
                                              Point2(-4.76618004f, 0.517315984f), Point2(4.76618004f, 0.517315984f)};

    std::vector<Point2<float>> subtrahendPoly = {Point2(4.76618004f, -3.86956978f), Point2(-4.76618004f, -3.86956978f),
...
void PolygonsSubtractionTest::polygonsSubtractionMaxIteration() { //see polygonsSubtractionMaxIteration.ggb
    std::vector<Point2<float>> minuendPoly = {Point2(0.724967539f, -6.26921654f), Point2(2.0384562f, -6.03173637f),
                                              Point2(1.0561136f, -8.09460735f)};

    std::vector<Point2<float>> subtrahendPoly = {Point2(0.756835938f, -6.38183594f), Point2(1.75683594f, -6.38183594f),
...
void PolygonsSubtractionTest::polygonsSubtractionTwoIntersectionsOnEdge() {
    std::vector<Point2<float>> minuendPoly = {Point2(-0.00646264944f, -6.47982645f), Point2(1.59619427f, -4.96815157f),
                                              Point2(1.53988385f, -6.4921689f)};

    std::vector<Point2<float>> subtrahendPoly = {Point2(2.45019531f, -4.84667969f), Point2(2.71777344f, -6.58496094f),
...
void PolygonsSubtractionTest::polygonsSubtractionCorner1() {
    ...
    std::vector<Point2<float>> subtrahendPoly = {Point2(3.0f, 4.0f), Point2(3.0f, 5.0f), Point2(5.0f, 5.0f),
...
void PolygonsSubtractionTest::polygonsSubtractionCorner2() {
    ...
    std::vector<Point2<float>> subtrahendPoly = {Point2(-1.0f, 2.0f), Point2(2.0f, 15.0f),
...
void PolygonsSubtractionTest::polygonsSubtractionCorner3() { //see polygonsSubtractionCorner3.ggb
    std::vector<Point2<float>> minuendPoly = {Point2(5.8386755f, -8.64567757f), Point2(4.47754383f, -7.34843636f),
                                              Point2(5.91046381f, -6.30504799f), Point2(7.27159405f, -7.60229063f)};

    std::vector<Point2<float>> subtrahendPoly = {Point2(4.0f, -6.0f), Point2(7.44508f, -6.18886f),
...
void PolygonsSubtractionTest::polygonsSubtractionCorner4() { //see polygonsSubtractionCorner4.ggb
    ...
    std::vector<Point2<float>> subtrahendPoly = {Point2(4.0f, -6.0f), Point2(70.5371094f, 20.34375f),
                                                 Point2(4.98730469f, -6.67675781f), Point2(5.31445312f, -7.43554688f)};
