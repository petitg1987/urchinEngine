...
void GJKContinuousCollisionAlgorithmTest::rayTest() { //test created from error logs where fail occurred with MAX_ITERATION=25 / TERMINATION_TOLERANCE=0.0001f
    ...
    PhysicsTransform boxFrom(Point3(8.625f, 1.875f, -17.25f), Quaternion<float>(0.0f, 1.0f, 0.0f, -1.62920685e-07f));
    PhysicsTransform boxTo(Point3(8.625f, 1.875f, -17.25f), Quaternion<float>(0.0f, 1.0f, 0.0f, -1.62920685e-07f));
