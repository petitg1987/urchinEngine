...
void InertiaCalculationTest::boxInertiaCalculation() {
    ...
    AssertHelper::instance()->assertFloatEquals(invWorldInertia(0, 0), 0.02307692307f);
    AssertHelper::instance()->assertFloatEquals(invWorldInertia(0, 1), 0.0f);
    AssertHelper::instance()->assertFloatEquals(invWorldInertia(0, 2), 0.0f);
    AssertHelper::instance()->assertFloatEquals(invWorldInertia(1, 0), 0.0f);
    AssertHelper::instance()->assertFloatEquals(invWorldInertia(1, 1), 0.06f);
    AssertHelper::instance()->assertFloatEquals(invWorldInertia(1, 2), 0.0f);
    AssertHelper::instance()->assertFloatEquals(invWorldInertia(2, 0), 0.0f);
    AssertHelper::instance()->assertFloatEquals(invWorldInertia(2, 1), 0.0f);
    AssertHelper::instance()->assertFloatEquals(invWorldInertia(2, 2), 0.03f);
}
