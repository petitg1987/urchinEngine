...
void ShapeToConvexObjectTest::boxConversion() {
    ...
    AssertHelper::instance()->assertPoint3FloatEquals(box->getCenterOfMass(), Point3<float>(1.0f, 1.0f, 1.0f));
    AssertHelper::instance()->assertFloatEquals(box->getHalfSize(0), 1.0f);
    AssertHelper::instance()->assertFloatEquals(box->getHalfSize(1), 2.0f);
    AssertHelper::instance()->assertFloatEquals(box->getHalfSize(2), 1.0f);
    AssertHelper::instance()->assertVector3FloatEquals(box->getAxis(0), Vector3<float>(1.0f, 0.0f, 0.0f));
    AssertHelper::instance()->assertVector3FloatEquals(box->getAxis(1), Vector3<float>(0.0f, 0.0f, 1.0f));
    AssertHelper::instance()->assertVector3FloatEquals(box->getAxis(2), Vector3<float>(0.0f, -1.0f, 0.0f));
}
...
void ShapeToConvexObjectTest::capsuleConversion() {
    ...
    AssertHelper::instance()->assertPoint3FloatEquals(capsule->getCenterOfMass(), Point3<float>(1.0f, 1.0f, 1.0f));
    AssertHelper::instance()->assertFloatEquals(capsule->getCylinderHeight(), 5.0f);
    AssertHelper::instance()->assertFloatEquals(capsule->getRadius(), 0.5f);
    AssertHelper::instance()->assertVector3FloatEquals(capsule->getAxis(0), Vector3<float>(1.0f, 0.0f, 0.0f));
    AssertHelper::instance()->assertVector3FloatEquals(capsule->getAxis(1), Vector3<float>(0.0f, 0.0f, 1.0f));
    AssertHelper::instance()->assertVector3FloatEquals(capsule->getAxis(2), Vector3<float>(0.0f, -1.0f, 0.0f));
}
...
void ShapeToConvexObjectTest::cylinderConversion() {
    ...
    AssertHelper::instance()->assertPoint3FloatEquals(cylinder->getCenterOfMass(), Point3<float>(1.0f, 1.0f, 1.0f));
    AssertHelper::instance()->assertFloatEquals(cylinder->getHeight(), 5.0f);
    AssertHelper::instance()->assertFloatEquals(cylinder->getRadius(), 0.5f);
    AssertHelper::instance()->assertVector3FloatEquals(cylinder->getAxis(0), Vector3<float>(1.0f, 0.0f, 0.0f));
    AssertHelper::instance()->assertVector3FloatEquals(cylinder->getAxis(1), Vector3<float>(0.0f, 0.0f, 1.0f));
    AssertHelper::instance()->assertVector3FloatEquals(cylinder->getAxis(2), Vector3<float>(0.0f, -1.0f, 0.0f));
}
...
void ShapeToConvexObjectTest::convexHullConversion() {
    ...
    AssertHelper::instance()->assertPoint3FloatEquals(convexHull->getPointsWithoutMargin()[0], Point3<float>(0.74710678118f, -0.6905382872f, -0.04f));
    AssertHelper::instance()->assertPoint3FloatEquals(convexHull->getPointsWithoutMargin()[1], Point3<float>(2.08132034356f, -2.0247519016f, -0.04f));
}
...
void ShapeToConvexObjectTest::sphereConversion() {
    ...
    AssertHelper::instance()->assertFloatEquals(sphere->getRadius(), 20.0f);
    AssertHelper::instance()->assertPoint3FloatEquals(sphere->getCenterOfMass(), Point3<float>(1.0f, 1.0f, 1.0f));
}
