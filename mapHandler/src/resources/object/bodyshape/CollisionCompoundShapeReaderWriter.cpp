...
namespace urchin {
    ...
    void CollisionCompoundShapeReaderWriter::writeTransformOn(const DataChunk* localizedShapeChunk, const LocalizedCollisionShape& localizedShape, DataWriter& dataWriter) {
