...
namespace urchin {
    ...
    Model* ModelReaderWriter::loadFrom(const std::shared_ptr<XmlChunk>& modelChunk, const XmlParser& xmlParser) {
    ...
    void ModelReaderWriter::writeOn(const std::shared_ptr<XmlChunk>& modelChunk, const Model* model, XmlWriter& xmlWriter) {
    ...
    void ModelReaderWriter::loadAnimationsOn(Model* model, const std::shared_ptr<XmlChunk>& modelChunk, const XmlParser& xmlParser) {
    ...
    void ModelReaderWriter::writeAnimationsOn(const std::shared_ptr<XmlChunk>& modelChunk, const Model* model, XmlWriter& xmlWriter) {
    ...
    void ModelReaderWriter::loadTransformOn(Model* model, const std::shared_ptr<XmlChunk>& modelChunk, const XmlParser& xmlParser) {
    ...
    void ModelReaderWriter::writeTransformOn(const std::shared_ptr<XmlChunk>& modelChunk, const Model* model, XmlWriter& xmlWriter) {
    ...
    void ModelReaderWriter::loadFlagsOn(Model* model, const std::shared_ptr<XmlChunk>& modelChunk, const XmlParser& xmlParser) {
    ...
    void ModelReaderWriter::writeFlagsOn(const std::shared_ptr<XmlChunk>& modelChunk, const Model* model, XmlWriter& xmlWriter) {
