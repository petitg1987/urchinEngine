...
namespace urchin
{
	...
	void RigidBodyReaderWriter::writeOn(std::shared_ptr<XmlChunk> physicsChunk, const RigidBody *rigidBody, XmlWriter &xmlWriter) const
	{
	...
	void RigidBodyReaderWriter::loadBodyPropertiesOn(RigidBody *rigidBody, std::shared_ptr<XmlChunk> physicsChunk, const XmlParser &xmlParser) const
	{
	...
	void RigidBodyReaderWriter::writeBodyPropertiesOn(std::shared_ptr<XmlChunk> physicsChunk, const RigidBody *rigidBody, XmlWriter &xmlWriter) const
	{
