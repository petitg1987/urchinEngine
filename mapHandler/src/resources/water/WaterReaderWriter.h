...
namespace urchin {
    ...
    class WaterReaderWriter {
        public:
            ...
            void writeOn(DataChunk&, const Water*, UdaWriter&) const;

        private:
            static void loadGeneralPropertiesOn(Water*, const DataChunk*, const DataParser&);
            static void writeGeneralPropertiesOn(DataChunk&, const Water*, UdaWriter&);

            static void loadWaterSurfaceProperties(Water*, const DataChunk*, const DataParser&);
            static void writeWaterSurfacePropertiesOn(DataChunk&, const Water*, UdaWriter&);

            static void loadUnderWaterProperties(Water*, const DataChunk*, const DataParser&);
            static void writeUnderWaterPropertiesOn(DataChunk&, const Water*, UdaWriter&);
