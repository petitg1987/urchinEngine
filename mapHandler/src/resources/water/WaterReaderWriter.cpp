...
namespace urchin {
    ...
    void WaterReaderWriter::loadGeneralPropertiesOn(Water* water, const std::shared_ptr<XmlChunk>& waterChunk, const XmlParser& xmlParser) {
    ...
    void WaterReaderWriter::writeGeneralPropertiesOn(const std::shared_ptr<XmlChunk>& waterChunk, const Water* water, XmlWriter& xmlWriter) {
    ...
    void WaterReaderWriter::loadWaterSurfaceProperties(Water* water, const std::shared_ptr<XmlChunk>& waterChunk, const XmlParser& xmlParser) {
    ...
    void WaterReaderWriter::writeWaterSurfacePropertiesOn(const std::shared_ptr<XmlChunk>& waterChunk, const Water* water, XmlWriter& xmlWriter) {
    ...
    void WaterReaderWriter::loadUnderWaterProperties(Water* water, const std::shared_ptr<XmlChunk>& waterChunk, const XmlParser& xmlParser) {
    ...
    void WaterReaderWriter::writeUnderWaterPropertiesOn(const std::shared_ptr<XmlChunk>& waterChunk, const Water* water, XmlWriter& xmlWriter) {
