...
namespace urchin {
    ...
    Quaternion<float> OrientationReaderWriter::loadOrientation(const std::shared_ptr<XmlChunk>& parentChunk, const XmlParser& xmlParser) {
    ...
    void OrientationReaderWriter::writeOrientation(const std::shared_ptr<XmlChunk>& parentChunk, const Quaternion<float>& orientation, XmlWriter& xmlWriter) {
