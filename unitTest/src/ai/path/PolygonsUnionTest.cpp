...
void PolygonsUnionTest::twoPolygonsIdenticalPoint()
{
	std::vector<Point2<float>> polyPoints1;
	polyPoints1.push_back(Point2<float>(0.0, -1.0));
	polyPoints1.push_back(Point2<float>(0.0, 0.0)); //identical point
	polyPoints1.push_back(Point2<float>(2.0, 1.0));

	std::vector<Point2<float>> polyPoints2;
	polyPoints2.push_back(Point2<float>(0.0, 0.0)); //identical point
...
CppUnit::Test *PolygonsUnionTest::suite()
{
	...
	suite->addTest(new CppUnit::TestCaller<PolygonsUnionTest>("twoPolygonsIdenticalPoint", &PolygonsUnionTest::twoPolygonsIdenticalPoint));
