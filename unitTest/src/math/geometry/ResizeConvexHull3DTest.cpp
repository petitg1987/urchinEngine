...
void ResizeConvexHull3DTest::tooMuchReduceBox()
{
	std::vector<Point3<float>> aabbPoints = {
			Point3<float>(0.0, 1.0, 0.0), Point3<float>(1.0, 1.0, 0.0), Point3<float>(1.0, -1.0, 0.0), Point3<float>(0.0, -1.0, 0.0),
			Point3<float>(0.0, 1.0, -1.0), Point3<float>(1.0, 1.0, -1.0), Point3<float>(1.0, -1.0, -1.0), Point3<float>(0.0, -1.0, -1.0)};
	...
	std::unique_ptr<ConvexHull3D<float>> convexHullResult = convexHull.resize(-0.51f);

	AssertHelper::assertTrue(convexHullResult.get()==nullptr);
}
...
CppUnit::Test *ResizeConvexHull3DTest::suite()
{
	...
	suite->addTest(new CppUnit::TestCaller<ResizeConvexHull3DTest>("tooMuchReduceBox", &ResizeConvexHull3DTest::tooMuchReduceBox));
