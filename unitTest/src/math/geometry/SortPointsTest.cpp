...
void SortPointsTest::fourPointsClockwise()
{
	...
	AssertHelper::assertPoint3FloatEquals(sortedPoints[0], Point3<float>(0.0, 0.0, 0.0));
	AssertHelper::assertPoint3FloatEquals(sortedPoints[1], Point3<float>(0.0, 0.0, -1.0));
	AssertHelper::assertPoint3FloatEquals(sortedPoints[2], Point3<float>(1.0, 0.0, -1.0));
	AssertHelper::assertPoint3FloatEquals(sortedPoints[3], Point3<float>(1.0, 0.0, 0.0));
}

void SortPointsTest::fourPointsCounterClockwise()
{
	std::vector<Point3<float>> fourPoints({
...
{
	CppUnit::TestSuite *suite = new CppUnit::TestSuite("SortPointsTest");
	...
	suite->addTest(new CppUnit::TestCaller<SortPointsTest>("fourPointsCounterClockwise", &SortPointsTest::fourPointsCounterClockwise));
