...
const uint LIGHTS_LIMIT = 15; //must be equals to LightManager::LIGHTS_LIMIT
layout(constant_id = 0) const uint NUMBER_SHADOW_MAPS = 7; //must be equals to ShadowManager::SHADOW_MAPS_LIMIT
...
layout(triangles) in;
layout(triangle_strip, max_vertices = 3 * LIGHTS_LIMIT) out;
