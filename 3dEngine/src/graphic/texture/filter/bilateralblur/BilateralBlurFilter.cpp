...
namespace urchin {
    ...
    void BilateralBlurFilter::addFurtherTextures(const std::shared_ptr<GenericDisplayer> &displayer) const {
        displayer->addAdditionalTexture(Texture::build(depthTextureID, Texture::DEFAULT, TextureParam::buildNearest()));
    }
