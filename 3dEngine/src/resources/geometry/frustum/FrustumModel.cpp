...
namespace urchin {
    ...
    std::vector<Point3<float>> FrustumModel::retrieveVertexArray(std::vector<uint32_t>& indices) const { //TODO review comment
    ...
    std::vector<LineSegment3D<float>> FrustumModel::retrieveWireframeLines() const { //TODO review comment
        std::array<Point3<float>, 8> points = frustum.getFrustumPoints();
