...
namespace urchin {
    ...
    class GeometryModel {
        ...
        protected:
            ...
            std::vector<Point3<float>> linesToVertexArray(const std::vector<LineSegment3D<float>>&, std::vector<uint32_t>&, std::vector<Point3<float>>&, std::vector<Point2<float>>&) const;
