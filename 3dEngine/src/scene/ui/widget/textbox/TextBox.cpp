...
namespace urchin {
    ...
    void TextBox::createOrUpdateWidget() {
        ...
        std::shared_ptr<Texture> selectionTexture = Texture::build("textSelection", 1, 1, TextureFormat::RGBA_32_FLOAT, &selectionColor, transparencyData, TextureDataType::FLOAT_32);
