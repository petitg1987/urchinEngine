...
namespace urchin {
    ...
    void Button::prepareWidgetRendering(float, unsigned int& renderingOrder, const Matrix4<float>& viewMatrix) {
        if (text) {
        ...
        updatePositioning(buttonRenderer.get(), viewMatrix, Vector2<int>(getGlobalPositionX(), getGlobalPositionY()));
