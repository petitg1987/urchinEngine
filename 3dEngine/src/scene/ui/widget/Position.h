...
namespace urchin {
    ...
    class Position {
        public:
            Position(float, LengthType, float, LengthType, RelativeTo = PARENT_LEFT_TOP, RefPoint = LEFT_TOP);
            Position(float, float, LengthType, RelativeTo = PARENT_LEFT_TOP, RefPoint = LEFT_TOP);
