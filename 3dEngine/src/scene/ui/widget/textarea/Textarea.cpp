...
namespace urchin {
    ...
    void Textarea::createOrUpdateWidget() {
        ...
        textContainer = Container::createScrollable(this, Position(0.0f, 0.0f, SCREEN_PERCENT, PARENT_CONTENT_LEFT_TOP), Size(100.0f, 100.0f, PARENT_PERCENT), scrollbarSkinName);
        ...
        texCursorAlbedo = Texture::build("cursor albedo", 1, 1, TextureFormat::RGBA_8_UINT_NORM, cursorColor.data(), TransparencyData::buildOpaque(), TextureDataType::INT_8);
        ...
        TransparencyData transparencyData = TransparencyData::buildFromAlpha(selectionColor.W, selectionColor.W);
        selectionTexture = Texture::build("textSelection", 1, 1, TextureFormat::RGBA_32_FLOAT, &selectionColor, transparencyData, TextureDataType::FLOAT_32);
