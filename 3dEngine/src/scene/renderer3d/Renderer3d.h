    ...
    class Renderer3d final : public Renderer, public Observer {
        ...
        private:
            struct DeferredSecondPassShaderConst {
                ...
                float shadowMapNormalBiasConstantFactor;
                float shadowMapNormalBiasSlopeFactor;
            ...
            struct SceneInfo {
                alignas(4) UgBool32 isShadowActivated;
                alignas(4) UgBool32 isAmbientOcclusionActivated;
            } sceneInfo;
