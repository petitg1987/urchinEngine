...
namespace urchin {
    ...
    OffsetTextureGenerator::OffsetTextureGenerator(unsigned int textureXYSize, unsigned int filterBoxSize) :
        ...
        if (filterBoxSize == 1) {
            ...
            offsetTexture = Texture::buildArray("SM offset", 1, 1, 1, TextureFormat::RG_32_FLOAT, textureData.data(), TransparencyData::buildOpaque(), TextureDataType::FLOAT_32);
        } else {
            ...
            offsetTexture = Texture::buildArray("SM offset", textureXYSize, textureXYSize, filterSize, TextureFormat::RG_32_FLOAT, textureData.data(), TransparencyData::buildOpaque(), TextureDataType::FLOAT_32);
        }
    }
