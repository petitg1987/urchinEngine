...
namespace urchin {
    ...
    ControlData::ControlData() noexcept {
        ...
        keysLabelMap[Control::Key::CTRL_LEFT] = "Ctrl";
        keysLabelMap[Control::Key::CTRL_RIGHT] = "Ctrl (right)";
        keysLabelMap[Control::Key::ALT_LEFT] = "Alt";
        keysLabelMap[Control::Key::ALT_RIGHT] = "Alt (right)";
        keysLabelMap[Control::Key::SHIFT_LEFT] = "Shift";
        keysLabelMap[Control::Key::SHIFT_RIGHT] = "Shift (right)";
        keysLabelMap[Control::Key::SUPER_LEFT] = "Super";
        keysLabelMap[Control::Key::SUPER_RIGHT] = "Super (right)";
