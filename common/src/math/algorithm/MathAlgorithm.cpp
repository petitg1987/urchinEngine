...
namespace urchin {
    ...
    template<class T> T MathAlgorithm::lerp(T v0, T v1, T t) { //see https://en.wikipedia.org/wiki/Linear_interpolation
     ...
     */
    template<class T> T MathAlgorithm::roundDivision(T dividend, T divisor) { //see https://stackoverflow.com/questions/17005364/dividing-two-integers-and-rounding-up-the-result-without-using-floating-point
