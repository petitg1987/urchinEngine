...
namespace urchin {
    ...
    template class std::unique_ptr<ContinuousCollisionResult<float>, AlgorithmResultDeleter> AlgorithmResultAllocator::newContinuousCollisionResult(AbstractBody& body2, const Vector3<float>& normalFromObject2, const Point3<float>& hitPointOnObject2, float timeToHit);
    ...
    template class std::unique_ptr<ContinuousCollisionResult<double>, AlgorithmResultDeleter> AlgorithmResultAllocator::newContinuousCollisionResult(AbstractBody& body2, const Vector3<double>& normalFromObject2, const Point3<double>& hitPointOnObject2, double timeToHit);
}
